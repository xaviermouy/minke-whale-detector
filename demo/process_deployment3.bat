...
rem ############################### Data info ############################
set AUDIO_DIR=C:\Users\xavie\OneDrive\Documents\Minke_detector\demo\data\deployment3
set FILES_EXT=.aif
set CHANNEL=8
set RECORDING_ID=USA-NEFSC-SBNMS-200609
set OUTPUT_DIR=C:\Users\xavie\OneDrive\Documents\Minke_detector\demo\results\deployment3
